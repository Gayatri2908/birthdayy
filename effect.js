...
//         // 🔥 Yahan se NEW BUTTON aayega
//         let button = $('<button id="wishBtn" class="happy-btn">See how much you are loved</button>');
//         $('body').append(button);
...
$(document).ready(function(){
    ...
    $('#balloons_flying').click(function(){
        $('.balloon-border').animate({top:-500},8000);
        loop('#b1'); loop('#b2'); loop('#b3'); loop('#b4'); loop('#b5'); loop('#b6'); loop('#b7');
